...
<button class="tablinks" onclick="openCity(event, 'Today')" >Today</button>
  <button class="tablinks" onclick="openCity(event, 'Yesterday')">Yesterday</button>
...
$date=date_default_timezone_set('Asia/Kolkata');
 ...
 $sql = "SELECT * FROM  StudentFollow where  DemoDate='$dt' and Comments!='Lead' and brand='$bid' order by DemoTime desc";
   ...
   echo" <table class='table table-hover'><tr><th scope='col'>S.No.</th><th scope='col'>Name</th><th scope='col'>Lead Source</th><th scope='col'>Lead Status</th><th scope='col'>Demo Date & Time</th><th scope='col'>Converted</th><th scope='col'>Remarks</th></tr>";
         ...
         while($row = mysqli_fetch_array($retval, MYSQLI_ASSOC)) {
			 $sqlq = "SELECT * ". 
            "FROM students where BrandId='{$row['SID']}' ";          
...
<div id="Yesterday" class="tabcontent">
 ...
 $an=0;
$date=date_default_timezone_set('Asia/Kolkata');
 $today=date('Y-m-d H:i',strtotime("-1 days"));
						$dt=substr($today,0,10);
         $rec_limit = 100;
		 		 echo"<font face='Verdana' size='3' color='#006666'><b>Call type :</font><font face='Verdana' size='2' color='brown'> Demo Scheduled &nbsp;&nbsp;&nbsp;&nbsp; </font> </b> <br>";
 $sql = "SELECT * FROM  StudentFollow where  DemoDate='$dt' and Comments!='Lead' and brand='$bid' order by DemoTime desc";
...
"  {$row['Comments']} </td></tr>";
	...
	{
		echo"<font face='Verdana' size='3' color='Red'><b><center><b>No Demo Scheduled for Yesterday</b></font>";
	}
...
$edate=$year."-".$month."-31";
 ...
 $sql = "SELECT * FROM  StudentFollow where DemoDate>='$fdate' and DemoDate<='$edate'  and brand='$bid' order by DemoDate desc,DemoTime desc";
...
<form name=myform method="post" action="demotoday.php">
...
$date=date_default_timezone_set('Asia/Kolkata');
 ...
 $sql = "SELECT * FROM  StudentFollow where DemoDate>='$fromdate' and DemoDate<='$todate' and brand='$bid' order by DemoDate desc,DemoTime desc";
...
$date=date_default_timezone_set('Asia/Kolkata');
 ...
 $sql = "SELECT * FROM  StudentFollow where DemoDate!='0000-00-00' and brand='$bid' order by DemoDate desc,DemoTime desc";
